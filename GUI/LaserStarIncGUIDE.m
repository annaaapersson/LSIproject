...
commonPhysicianLabel = uicontrol(...
    'Parent', background,...
    'Style', 'Text',...
    'BackgroundColor', 'white',...
    'Units', 'normalized',...
...
settingsPanel = uipanel(...
    ...
    'BackgroundColor', 'white')
        ...
        exposureSlider = uicontrol(...
            ...
            'Callback',{@exposureSlider_Callback, minExposure, maxExposure})
...
saveExaminationButton = uicontrol(...
    'Parent', saveMeasurementPanel,...
    'Style', 'Pushbutton',...
    'Units','normalized',...
...
enterpatientIDButton = uicontrol(...
    'Parent', enterPatientIDPanel,...
    'Style', 'Pushbutton',...
    'Units','normalized',...
    ...
    'String', 'Enter', ...
    'FontSize', 16,...
    'Callback',{@enterPatientIDButton_Callback,auxillaryPanel,...         
    enterPatientIDPanel, examinationPanel, examinationTablePanel,...   
    sectionButtonPanel,historyPanel,imageDisplayPanel,measurePanel, ...           
    patientDBPanel,patientInfoPanel,patientPanel,roi1Panel,...
    roi2Panel,saveMeasurementPanel,savePanel,settingsPanel,...
...
backToExaminationsButton = uicontrol(...
    'Parent', examinationPanel,...
    'Units','normalized',...
    ...
    'FontSize',18, ...
    'Style', 'Pushbutton', ...
    'Callback', {@returnButton_Callback, auxillaryPanel,...         
    enterPatientIDPanel, examinationPanel, examinationTablePanel,...   
    sectionButtonPanel,historyPanel,imageDisplayPanel,measurePanel, ...           
    patientDBPanel,patientInfoPanel,patientPanel,roi1Panel,...
    roi2Panel,saveMeasurementPanel,savePanel,settingsPanel,...

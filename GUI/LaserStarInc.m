...
handles.roi1Panel = uipanel(...
    'Parent', handles.measurePanel, ...
    'Position',[35/425 49/605 380/425 398/605], ...
    'BackgroundColor', 'white',...
    'Visible', 'off',...
    'Bordertype', 'none');
...
handles.startRecordingPanel = uipanel(...
    ...
    'BackgroundColor','white');
        ...
        handles.roiGraph = axes(...
            ...
            'Position',[35/425 185/460 375/425 380/460])
        ...
        handles.examinationTablePanel = uipanel(...
            ...
            'Visible', 'off');
                ...
                handles.examinationDataTable = uitable(...
                    ...
                    'Physician','Measurement Points','Gain','Exposure','Frames per Second',...
                    'Kernel Size','Image 1','Image 2','Image 3'},...

...
handles.commonPatientIDLabel = uicontrol(...
    ...
    'BackgroundColor', 'white',...
    'Units', 'normalized',...
    'Position', [785/1020 615/640 150/1020 20/640],...
    'HorizontalAlignment', 'left',...
    'FontSize', 16,...
    'String', patientName);
...
%#################################################
minIso = 0; maxIso = 5; iso = 3;
minExposure = 5; maxExposure = 10; exposure = 7;
minKernel = 2; maxKernel = 5; kernel = 5;

minKernelLabel = [num2str(minKernel) 'x' num2str(minKernel)];
maxKernelLabel = [num2str(maxKernel) 'x' num2str(maxKernel)];
...
handles.settingsPanel = uipanel(...
    ...
    'BackgroundColor', 'white');
        ...
        handles.kernelLabel = uicontrol(...
            'Parent', handles.settingsPanel,...
            'Units', 'Normalized',...
            'Position', [51/425 186/605 60/425 25/605],...
            'Style', 'Text',...
            'String', 'Kernel',...
            'FontSize', 20,...
            'BackgroundColor', 'White');
        ...
        handles.kernelMinLabel = uicontrol(...
            'Parent', handles.settingsPanel,...
            'Units', 'Normalized',...
            'Position', [145/425 186/605 60/425 25/605],...
            'Style', 'Text',...
        ...
        % label for maximum kernel size
         handles.kernelMaxLabel = uicontrol(...
            'Parent', handles.settingsPanel,...
            'Units', 'Normalized',...
            'Position', [325/425 186/605 60/425 25/605],...
            'Style', 'Text',...
        ...
        handles.kernSlider = uicontrol(...
            ...
            'Tag', 'kernelSize',...
            'Callback', {@kernSlider_Callback, handles});
            %'Callback', {@kernSlider_Callback, handles, datas});
        
        %%%%%%%%%%%%%
        %currentKernelLabel = [num2str(handles.kernSlider.Value)...
        %    'x' num2str(handles.kernSlider.Value)]; 
        %%%%%%%%%%%%
        ...
        % label showing the current kernel size
         handles.kernelCurrentLabel = uicontrol(...
            'Parent', handles.settingsPanel,...
            'Units', 'Normalized',...
            'Position', [235/425 186/605 60/425 25/605],...
            'Style', 'Text',...
        ...
        handles.gainLabel = uicontrol(...
            'Parent', handles.settingsPanel,...
            'Units', 'Normalized',...
            'Position', [49/425 330/605 60/425 25/605],...
            'Style', 'Text',...
            'String', 'Gain',...
            'FontSize', 20,...
            'BackgroundColor', 'White');
        ...
        handles.minGainLabel = uicontrol(...
            'Parent', handles.settingsPanel,...
            'Units', 'Normalized',...
            'Position', [145/425 330/605 60/425 25/605],...
            'Style', 'Text',...
            'String', 50*2^minIso,...
            'FontSize', 20,...
            'HorizontalAlignment', 'left',...
        ...
        % label for maximum exposure
         handles.maxGainLabel = uicontrol(...
            'Parent', handles.settingsPanel,...
            'Units', 'Normalized',...
            'Position', [325/425 330/605 60/425 25/605],...
            'Style', 'Text',...
            'String', 50* 2^maxIso,...
            'FontSize', 20,...
            'HorizontalAlignment', 'right',...
        ...
        handles.exposureLabel = uicontrol(...
            'Parent', handles.settingsPanel,...
            'Units', 'Normalized',...
            'Position', [51/425 474/605 90/425 25/605],...
            'Style', 'Text',...
            'String', 'Exposure',...
            'FontSize', 20,...
            'BackgroundColor', 'White');
        ...
        handles.exposureMinLabel = uicontrol(...
            'Parent', handles.settingsPanel,...
            'Units', 'Normalized',...
            'Position', [145/425 474/605 60/425 25/605],...
            'Style', 'Text',...
            'String', minExposure,...
            'FontSize', 20,...
            'HorizontalAlignment', 'left',...
        ...
        % label for maximum exposure
         handles.exposureMaxLabel = uicontrol(...
            'Parent', handles.settingsPanel,...
            'Units', 'Normalized',...
            'Position', [325/425 474/605 60/425 25/605],...
            'Style', 'Text',...
            'String', maxExposure,...
            'FontSize', 20,...
            'HorizontalAlignment', 'right',...
...
handles.patientPanel = uipanel(...
    ...
    'Visible', 'off');
        ...
        handles.registerPatientLabel = uicontrol(...
            ...
            'Style', 'Text',...
            'Units','normalized', ...
            'Position', [35/425 268/460 380/425 35/460], ...
...
% TODO: symbol for remove / add
        ...
        handles.apply12Button = uicontrol(...
            ...
            'Style', 'Pushbutton',...
            'String', 'Apply',...
            'Callback', {@apply12Button_Callback, handles, datas});
        ...
        handles.apply11Button = uicontrol(...
            ...
            'Style', 'Pushbutton',...
            'String', 'Apply',...
            'Callback', {@apply11Button_Callback, handles, datas});
...
%--------------------------------------------------------------------------
        ...
        handles.apply22Button = uicontrol(...
            ...
            'Style', 'Pushbutton', ...
            'String', 'Apply',...
            'Callback', {@apply22Button_Callback, handles, datas});
        ...
        handles.apply21Button = uicontrol(...
            ...
            'Style', 'Pushbutton', ...
            'String', 'Apply',...
            'Callback', {@apply21Button_Callback, handles, datas});
        ...
        handles.enterPatientIDPanel = uipanel(...
            ...
            'BackgroundColor','white');
                ...
                handles.enterPatientLabel = uicontrol(...
                    ...
                    'Style', 'Text',...
                    'Units','normalized',...
                    'Position', [20/455 61/110 150/455 27/110], ...
        ...
        handles.patientDBPanel = uipanel(...
            ...
            'BackgroundColor','white');
                ...
                handles.nameDBEdit = uicontrol(...
                    ...
                    'Style','Edit', ...
                    'Units','normalized',...
                    'Position', [335/950 230/428 480/950 30/428]);

                handles.SSNDBEdit = uicontrol(...
                    'Parent', handles.patientDBPanel,...
                    'Style','Edit',...
                    'Units','normalized',...
                    'Position', [335/950 170/428 480/950 30/428]);
...
handles.laserStopButton = uicontrol(...
    ...
    'Callback', {@stopLaserButton_Callback, handles});
